...
/*
 ...
 input_file            : /home/pi/workspace/envirophat-o/device_output/out_codegeneration_merged.swagger.json
...
class BrightnessResource : public Resource
{
    ...
    private:
        ...
        int m_var_value_brightness; // the value for the attribute "brightness": The Quantized representation in the range 0-100 of the current sensed or set value for Brightness.
...
BrightnessResource::BrightnessResource(std::string resourceUri)
{
    ...
    m_var_value_brightness = 50; // current value of property "brightness" The Quantized representation in the range 0-100 of the current sensed or set value for Brightness.
...
class ColorResource : public Resource
{
    ...
    private:
        ...
        std::string m_var_value_n; // the value for the attribute "n": Friendly name of the Resource
        std::string m_var_name_n = "n"; // the name for the attribute "n"
        std::vector<int>  m_var_value_rgbValue; // the value for the array attribute "rgbValue": The RGB value; the first item is the R, second the G, third the B.
...
ColorResource::ColorResource(std::string resourceUri)
{
    ...
    m_var_value_if.push_back("oic.if.s");
    m_var_value_n = "";  // current value of property "n" Friendly name of the Resource
    // initialize vector rgbValue  The RGB value; the first item is the R, second the G, third the B.m_var_value_rgbValue.push_back(255);
...
class HeadingResource : public Resource
{
    ...
    private:
        ...
        std::vector<std::string>  m_var_value_rt; // the value for the array attribute "rt": The Resource Type.
        std::string m_var_name_rt = "rt"; // the name for the attribute "rt"
        std::vector<double>  m_var_value_value; // the value for the array attribute "value": The array containing Hx, Hy, Hz.
        std::string m_var_name_value = "value"; // the name for the attribute "value"
...
HeadingResource::HeadingResource(std::string resourceUri)
{
    ...
    // initialize vector value  The array containing Hx, Hy, Hz.m_var_value_value.push_back(100.0);
...
class PressureResource : public Resource
{
    ...
    private:
        ...
        double m_var_value_atmosphericPressure; // the value for the attribute "atmosphericPressure": The current atmospheric pressure in hPa.
...
PressureResource::PressureResource(std::string resourceUri)
{
    ...
    m_var_value_atmosphericPressure = 1000.4; // current value of property "atmosphericPressure"  The current atmospheric pressure in hPa.
    m_var_value_id = "";  // current value of property "id" Instance ID of this specific Resource
    // initialize vector if  The OCF Interface set supported by this Resource.
    m_var_value_if.push_back("oic.if.baseline");
    m_var_value_if.push_back("oic.if.s");
    m_var_value_n = "";  // current value of property "n" Friendly name of the Resource
...
class TemperatureResource : public Resource
{
    ...
    private:
        ...
        std::vector<std::string>  m_var_value_rt; // the value for the array attribute "rt": The Resource Type.
        std::string m_var_name_rt = "rt"; // the name for the attribute "rt"
        double m_var_value_temperature; // the value for the attribute "temperature": The current temperature setting or measurement.
        std::string m_var_name_temperature = "temperature"; // the name for the attribute "temperature"
        std::string m_var_value_units; // the value for the attribute "units": The unit for the conveyed temperature value, Note that when doing an UPDATE, the unit on the device does NOT change, it only indicates the unit of the conveyed value during the UPDATE operation.
...
TemperatureResource::TemperatureResource(std::string resourceUri)
{
    ...
    m_var_value_temperature = 20.0; // current value of property "temperature"  The current temperature setting or measurement.
    m_var_value_units = "C";  // current value of property "units" The unit for the conveyed temperature value, Note that when doing an UPDATE, the unit on the device does NOT change, it only indicates the unit of the conveyed value during the UPDATE operation.
    }
...
class XmotionResource : public Resource
{
    ...
    private:
        ...
        double m_var_value_acceleration; // the value for the attribute "acceleration": The sensed acceleration experienced in 'g'.
...
XmotionResource::XmotionResource(std::string resourceUri)
{
    ...
    m_var_value_acceleration = 0.5; // current value of property "acceleration"  The sensed acceleration experienced in 'g'.
    // initialize vector if  The OCF Interface set supported by this Resource.
    m_var_value_if.push_back("oic.if.baseline");
    m_var_value_if.push_back("oic.if.s");
    m_var_value_n = "";  // current value of property "n" Friendly name of the Resource
