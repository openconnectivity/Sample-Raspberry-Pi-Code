...
/*
 ...
 input_file            : /home/pi/tmp/automationhattest/device_output/out_codegeneration_merged.swagger.json
...
/*
* Make the payload for the observe function (e.g. GET) /CommsLight
*/
...
* @param pResponse  the response to use for the observe
*/
OCStackResult CommslightResource::sendNotification(const std::shared_ptr< OCResourceResponse > pResponse)
{
    OCStackResult sResult = OC_STACK_OK;
    if ( m_interestedObservers.size() > 0) {
        std::cout << "Notifying list "  << m_interestedObservers.size() << " of observers\n";
...
OCEntityHandlerResult CommslightResource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
    ...
    if (ehResult == OC_EH_OK)
    {
      ...
      testAutomationHat->myParamArgs[0] = m_var_value_value ? 1 : 0;
      testAutomationHat->CallPythonFunction((char *)"automation-hat", (char *)"writeCommsLight", 1, testAutomationHat->myParamArgs);
    }
    return ehResult;
}
/*
...
/*
* Make the payload for the observe function (e.g. GET) /PowerLight
*/
...
* @param pResponse  the response to use for the observe
*/
OCStackResult PowerlightResource::sendNotification(const std::shared_ptr< OCResourceResponse > pResponse)
{
    OCStackResult sResult = OC_STACK_OK;
    if ( m_interestedObservers.size() > 0) {
        std::cout << "Notifying list "  << m_interestedObservers.size() << " of observers\n";
...
OCEntityHandlerResult PowerlightResource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
    ...
    if (ehResult == OC_EH_OK)
    {
	    ...
	    // the member values have been updated already with the request data
      testAutomationHat->myParamArgs[0] = m_var_value_value ? 1 : 0;
      testAutomationHat->CallPythonFunction((char *)"automation-hat", (char *)"writePowerLight", 1, testAutomationHat->myParamArgs);
    }
    return ehResult;
}
/*
...
/*
* Make the payload for the observe function (e.g. GET) /WarnLight
*/
...
* @param pResponse  the response to use for the observe
*/
OCStackResult WarnlightResource::sendNotification(const std::shared_ptr< OCResourceResponse > pResponse)
{
    OCStackResult sResult = OC_STACK_OK;
    if ( m_interestedObservers.size() > 0) {
        std::cout << "Notifying list "  << m_interestedObservers.size() << " of observers\n";
...
OCEntityHandlerResult WarnlightResource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
    ...
    if (ehResult == OC_EH_OK)
    {
    	...
    	// the member values have been updated already with the request data
      testAutomationHat->myParamArgs[0] = m_var_value_value ? 1 : 0;
      testAutomationHat->CallPythonFunction((char *)"automation-hat", (char *)"writeWarnLight", 1, testAutomationHat->myParamArgs);
    }
    return ehResult;
}
/*
...
/*
* Make the payload for the observe function (e.g. GET) /relay1
*/
...
* @param pResponse  the response to use for the observe
*/
OCStackResult Relay1Resource::sendNotification(const std::shared_ptr< OCResourceResponse > pResponse)
{
    OCStackResult sResult = OC_STACK_OK;
    if ( m_interestedObservers.size() > 0) {
        std::cout << "Notifying list "  << m_interestedObservers.size() << " of observers\n";
...
/*
* Make the payload for the observe function (e.g. GET) /relay2
*/
...
* @param pResponse  the response to use for the observe
*/
OCStackResult Relay2Resource::sendNotification(const std::shared_ptr< OCResourceResponse > pResponse)
{
    OCStackResult sResult = OC_STACK_OK;
    if ( m_interestedObservers.size() > 0) {
        std::cout << "Notifying list "  << m_interestedObservers.size() << " of observers\n";
...
/*
* Make the payload for the observe function (e.g. GET) /relay3
*/
...
* @param pResponse  the response to use for the observe
*/
OCStackResult Relay3Resource::sendNotification(const std::shared_ptr< OCResourceResponse > pResponse)
{
    OCStackResult sResult = OC_STACK_OK;
    if ( m_interestedObservers.size() > 0) {
        std::cout << "Notifying list "  << m_interestedObservers.size() << " of observers\n";
