...
cp -f ${EXAMPLEPATH}/Sample-Raspberry-Pi-Code/IoTivity-lite/explorer-hat-pro/Makefile ${CURPWD}/Makefile
cp -f ${EXAMPLEPATH}/Sample-Raspberry-Pi-Code/IoTivity-lite/explorer-hat-pro/explorer-hat-pro-config.json ${CURPWD}/${PROJNAME}-config.json
