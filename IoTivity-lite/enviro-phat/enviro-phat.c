...
app_init(void)
{
  ...
  ret |= oc_add_device("/oic/d", "oic.d.envirophat", "Enviro Phat",
                       "ocf.1.0.0", /* icv value */
...
int init;
  ...
  PRINT("OCF Server name : \"Enviro Phat\"\n");
  ...
  PRINT("OCF server \"Enviro Phat\" running, waiting on incomming connections.\n");
