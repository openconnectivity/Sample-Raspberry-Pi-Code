...
// membervariables for path: /relay
static char g_relay_RESOURCE_PROPERTY_NAME_value[] = "value"; // the name for the attribute
//bool g_relay_value; // the value for the attribute

bool g_relay_value = false; // current value of property "value" Status of the switch// variables for the resources
...
/**
*  get method for /relay to assign the returned values to the member values
* @param request the request representation.
* @param interfaces the interfaces.
* @param user_data the user data.
* TODO: this function is also referenced when only get is implemented, something to fix..
...
/**
*  post method for /relay to assign the returned values to the member values
* @param requestRep the request representation.
*/
static void
